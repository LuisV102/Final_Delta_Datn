...
image_folder = r"D:\TAI LIEU MON HOC\Do_an_tot_nghiep\Object_Detection_1\Anh_ban_co"
images = glob.glob(os.path.join(image_folder, '*.jpg'))  # Đọc tất cả ảnh calib_1.jpg, calib_2.jpg, ...
